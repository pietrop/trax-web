...
export const PlayIconSVG = (props: any) => (
  ...
  // |>| Next
  export const NextIconSVG = (props: any) => (
    <ButtonIconSVG {...props}>
  ...
  // |<| Prev
  export const PrevIconSVG = (props: any) => (
    <ButtonIconSVG {...props}>
  ...
  // Volume
  export const VolumeIconSVG = (props: any) => (
    <svg
  ...
  export const VolumeIconLoudSVG = (props: any) => (
    <VolumeIconSVG {...props}>
  ...
  export const VolumeIconMuteSVG = (props: any) => (
    <VolumeIconSVG {...props}>
